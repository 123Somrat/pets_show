...
export default function Login() {
  ...
  return (
    ...
    <p className="text-xs text-center sm:px-6 dark:text-gray-400">Don't have an account yet?
      <a rel="noopener noreferrer" href="/register" className="underline dark:text-gray-100">Register</a>
    </p>
  </div>
  )
}
